...
const Home: React.FC = () => {
  ...
  const handleEventClick = async (clickInfo: { event: { title: string; }; }) => {
    console.log('Clicked event:', clickInfo.event);
    try {
      //on appelle les fonction de suppression d'evenement avec nom de l'evenement
  ...
  const handleEventDrop = async (info: { event: any; }) => {
    ...
    //preparation des données pour la mise à jour
    ...
    try {
      ...
      console.error('Erreur lors de la mise à jour de l\'événement :', (error as Error).message);
    }
  };
        ...
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
          <div className="grid grid-cols-10 font-bold text-2xl text-gray-200">
            <div className="col-span-8">
              ...
              {/* Affiche Agenda et capte les changements en appelant les methodes */}
              <CalendarComponent
