...
var app = (function () {
    ...
    // (36:3) <Link      to="/messagerie"      class="py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md transition duration-300"     >
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(36:3) <Link      to=\\\"/messagerie\\\"      class=\\\"py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md transition duration-300\\\"     >",
    		ctx
    	});
    ...
    const file$6 = "src\\components\\Settings_page.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$6, 87, 12, 3422);
    			...
    			add_location(img, file$6, 90, 16, 3566);
    			...
    			add_location(button, file$6, 92, 14, 3677);
    			attr_dev(div0, "class", "flex items-center mb-2 space-x-4");
    			add_location(div0, file$6, 88, 12, 3486);
    			attr_dev(p0, "class", "mb-2");
    			add_location(p0, file$6, 94, 12, 3879);
    			attr_dev(p1, "class", "mb-2");
    			add_location(p1, file$6, 95, 12, 3932);
    			attr_dev(p2, "class", "mb-2");
    			add_location(p2, file$6, 96, 12, 4001);
    			attr_dev(p3, "class", "mb-2");
    			add_location(p3, file$6, 97, 12, 4077);
    			attr_dev(div1, "class", "text-container");
    			set_style(div1, "margin-left", "20px");
    			add_location(div1, file$6, 86, 10, 3353);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, h4);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$6, 82, 12, 2956);
    			...
    			add_location(button1, file$6, 83, 12, 3130);
    			attr_dev(form, "class", "text-container");
    			set_style(form, "margin-left", "20px");
    			add_location(form, file$6, 72, 10, 2013);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$5, 26, 4, 590);
    			...
    			add_location(input1, file$5, 42, 4, 1147);
    			attr_dev(p1, "class", "text-gray-600 text-xs italic");
    			add_location(p1, file$5, 49, 4, 1399);
    			attr_dev(div1, "class", "mb-6");
    			add_location(div1, file$5, 38, 2, 1014);
    			...
    			add_location(button, file$5, 51, 2, 1477);
    			attr_dev(form, "class", "w-full max-w-sm mx-auto mt-20");
    			add_location(form, file$5, 21, 0, 470);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src\\components\\Register.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$4, 28, 6, 590);
    			add_location(div0, file$4, 27, 4, 577);
    			attr_dev(label0, "for", "username");
    			attr_dev(label0, "class", "sr-only");
    			add_location(label0, file$4, 35, 10, 865);
    			...
    			add_location(input0, file$4, 36, 10, 931);
    			add_location(div1, file$4, 34, 8, 848);
    			attr_dev(label1, "for", "email");
    			attr_dev(label1, "class", "sr-only");
    			add_location(label1, file$4, 47, 10, 1410);
    			...
    			add_location(input1, file$4, 48, 10, 1478);
    			add_location(div2, file$4, 46, 8, 1393);
    			attr_dev(label2, "for", "password");
    			attr_dev(label2, "class", "sr-only");
    			add_location(label2, file$4, 59, 10, 1954);
    			...
    			add_location(input2, file$4, 60, 10, 2020);
    			add_location(div3, file$4, 58, 8, 1937);
    			attr_dev(div4, "class", "rounded-md shadow-sm -space-y-px");
    			add_location(div4, file$4, 33, 6, 792);
    			attr_dev(path0, "fill-rule", "evenodd");
    			attr_dev(path0, "d", "M10 12a2 2 0 100-4 2 2 0 000 4z");
    			attr_dev(path0, "clip-rule", "evenodd");
    			add_location(path0, file$4, 86, 14, 3221);
    ...
    /* src\components\Messagerie.svelte generated by Svelte v3.59.2 */
    const file$3 = "src\\components\\Messagerie.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			h3 = element("h3");
    			h3.textContent = "Messagerie";
    			t1 = space();
    			div0 = element("div");
    			attr_dev(h3, "class", "text-2xl font-bold mb-4");
    			add_location(h3, file$3, 7, 4, 167);
    			attr_dev(div0, "class", "grid grid-cols-1 sm:grid-cols-2 gap-4");
    			add_location(div0, file$3, 8, 4, 225);
    			attr_dev(div1, "class", "container mx-auto p-4 bg-gray-900 text-white rounded-lg shadow-lg svelte-10qtssi");
    			add_location(div1, file$3, 6, 2, 82);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Messagerie', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Messagerie> was created with unknown prop '${key}'`);
    	});
    ...
    class Messagerie extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 12, 2, 463);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 8, 1, 146);
    			attr_dev(h1, "class", "text-4xl font-bold mb-8");
    			add_location(h1, file, 9, 2, 228);
    			add_location(div, file, 7, 2, 138);
