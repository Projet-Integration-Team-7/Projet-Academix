...
var app = (function () {
    ...
    // (20:4) <Link        to="/settings_page"        class="py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md transition duration-300"      >
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(20:4) <Link        to=\\\"/settings_page\\\"        class=\\\"py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md transition duration-300\\\"      >",
    		ctx
    	});
    ...
    // (15:6) <Link          to="/settings/profile"          class="py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md transition duration-300"          >
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(15:6) <Link          to=\\\"/settings/profile\\\"          class=\\\"py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md transition duration-300\\\"          >",
    		ctx
    	});
    ...
    // (25:6) <Link          to="/settings/account"          class="py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md transition duration-300"          >
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(25:6) <Link          to=\\\"/settings/account\\\"          class=\\\"py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md transition duration-300\\\"          >",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			p0 = element("p");
    			p0.textContent = "Name: John Doe";
    			t5 = space();
    			p1 = element("p");
    			p1.textContent = "Email: johndoe@example.com";
    			t7 = space();
    			p2 = element("p");
    			p2.textContent = "Bio: Lorem ipsum dolor sit amet, consectetur adipiscing elit.";
    			t9 = space();
    			create_component(link0.$$.fragment);
    			t10 = space();
    			div1 = element("div");
    			h41 = element("h4");
    			h41.textContent = "Account";
    			t12 = space();
    			p3 = element("p");
    			p3.textContent = "Username: johndoe";
    			t14 = space();
    			p4 = element("p");
    			...
    			add_location(h40, file$4, 8, 6, 316);
    			attr_dev(p0, "class", "mb-2");
    			add_location(p0, file$4, 9, 6, 375);
    			attr_dev(p1, "class", "mb-2");
    			add_location(p1, file$4, 10, 6, 417);
    			attr_dev(p2, "class", "mb-2");
    			add_location(p2, file$4, 11, 6, 471);
    			attr_dev(div0, "class", "bg-gray-800 rounded-lg shadow-md p-4");
    			add_location(div0, file$4, 7, 4, 258);
    			attr_dev(h41, "class", "text-lg font-semibold mb-2");
    			add_location(h41, file$4, 21, 6, 856);
    			attr_dev(p3, "class", "mb-2");
    			add_location(p3, file$4, 22, 6, 915);
    			attr_dev(p4, "class", "mb-2");
    			add_location(p4, file$4, 23, 6, 960);
    			attr_dev(div1, "class", "bg-gray-800 rounded-lg shadow-md p-4");
    			add_location(div1, file$4, 20, 4, 798);
    			attr_dev(div2, "class", "grid grid-cols-1 sm:grid-cols-2 gap-4");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$3, 26, 4, 590);
    			...
    			add_location(input1, file$3, 42, 4, 1147);
    			attr_dev(p1, "class", "text-gray-600 text-xs italic");
    			add_location(p1, file$3, 49, 4, 1399);
    			attr_dev(div1, "class", "mb-6");
    			add_location(div1, file$3, 38, 2, 1014);
    			...
    			add_location(button, file$3, 51, 2, 1477);
    			attr_dev(form, "class", "w-full max-w-sm mx-auto mt-20");
    			add_location(form, file$3, 21, 0, 470);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 28, 6, 590);
    			add_location(div0, file$2, 27, 4, 577);
    			attr_dev(label0, "for", "username");
    			attr_dev(label0, "class", "sr-only");
    			add_location(label0, file$2, 35, 10, 865);
    			...
    			add_location(input0, file$2, 36, 10, 931);
    			add_location(div1, file$2, 34, 8, 848);
    			attr_dev(label1, "for", "email");
    			attr_dev(label1, "class", "sr-only");
    			add_location(label1, file$2, 47, 10, 1410);
    			...
    			add_location(input1, file$2, 48, 10, 1478);
    			add_location(div2, file$2, 46, 8, 1393);
    			attr_dev(label2, "for", "password");
    			attr_dev(label2, "class", "sr-only");
    			add_location(label2, file$2, 59, 10, 1954);
    			...
    			add_location(input2, file$2, 60, 10, 2020);
    			add_location(div3, file$2, 58, 8, 1937);
    			attr_dev(div4, "class", "rounded-md shadow-sm -space-y-px");
    			add_location(div4, file$2, 33, 6, 792);
    			attr_dev(path0, "fill-rule", "evenodd");
    			attr_dev(path0, "d", "M10 12a2 2 0 100-4 2 2 0 000 4z");
    			attr_dev(path0, "clip-rule", "evenodd");
    			add_location(path0, file$2, 86, 14, 3221);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 10, 2, 333);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
