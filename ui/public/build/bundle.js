...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h3 = element("h3");
    			h3.textContent = "Page Accueil";
    			t1 = space();
    			create_component(link0.$$.fragment);
    			br = element("br");
    			t2 = space();
    			create_component(link1.$$.fragment);
    			add_location(h3, file$4, 6, 2, 96);
    			add_location(br, file$4, 7, 32, 151);
    			add_location(div, file$4, 5, 0, 87);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$3, 23, 4, 533);
    			attr_dev(input0, "type", "email");
    			attr_dev(input0, "id", "email");
    			input0.required = true;
    			add_location(input0, file$3, 24, 4, 571);
    			add_location(p0, file$3, 25, 4, 638);
    			add_location(div0, file$3, 22, 2, 522);
    			attr_dev(label1, "for", "password");
    			add_location(label1, file$3, 28, 4, 695);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "id", "password");
    			input1.required = true;
    			add_location(input1, file$3, 29, 4, 739);
    			add_location(p1, file$3, 30, 4, 815);
    			add_location(div1, file$3, 27, 2, 684);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$3, 32, 2, 856);
    			add_location(form, file$3, 21, 0, 472);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			p0 = element("p");
    			p0.textContent = "Enter your desired username.";
    			t4 = space();
    			div1 = element("div");
    			label1 = element("label");
    			...
    			t7 = space();
    			p1 = element("p");
    			p1.textContent = "Enter your email address.";
    			t9 = space();
    			div2 = element("div");
    			...
    			t12 = space();
    			p2 = element("p");
    			p2.textContent = "Enter a password.";
    			t14 = space();
    			button = element("button");
    			button.textContent = "Register";
    			attr_dev(label0, "for", "username");
    			add_location(label0, file$2, 22, 6, 530);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "username");
    			input0.required = true;
    			add_location(input0, file$2, 23, 6, 576);
    			add_location(p0, file$2, 24, 6, 650);
    			add_location(div0, file$2, 21, 4, 517);
    			attr_dev(label1, "for", "email");
    			add_location(label1, file$2, 27, 6, 716);
    			attr_dev(input1, "type", "email");
    			attr_dev(input1, "id", "email");
    			input1.required = true;
    			add_location(input1, file$2, 28, 6, 756);
    			add_location(p1, file$2, 29, 6, 825);
    			add_location(div1, file$2, 26, 4, 703);
    			attr_dev(label2, "for", "password");
    			add_location(label2, file$2, 32, 6, 888);
    			attr_dev(input2, "type", "password");
    			attr_dev(input2, "id", "password");
    			input2.required = true;
    			add_location(input2, file$2, 33, 6, 934);
    			add_location(p2, file$2, 34, 6, 1012);
    			add_location(div2, file$2, 31, 4, 875);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$2, 36, 4, 1054);
    			add_location(form, file$2, 20, 2, 463);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 9, 2, 266);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Home, Login, Register });
    	return [];
    }
