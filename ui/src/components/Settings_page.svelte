...
<body class="   bg-gray-900 text-white w-screen h-screen">
  ...
  <div
    class="container mx-auto p-4 bg-gray-900 text-white rounded-lg shadow-lg"
  >
    <div
        ...
        {#if isEditing}
          ...
          >
            ...
            <input
              type="text"
              placeholder="Nom"
              class="mb-2 bg-gray-700 text-white rounded-lg p-2"
            ...
            <input
              ...
              class="mb-2 bg-gray-700 text-white rounded-lg p-2"
              bind:value={formData.motDePasse}
            />
            <input
              type="email"
              placeholder="Adresse couriel"
              class="mb-2 bg-gray-700 text-white rounded-lg p-2"
              bind:value={formData.adresseCouriel}
            />
            <select
              class="mb-2 bg-gray-700 text-white rounded-lg p-2"
            ...
            <button
              type="button"
              class="py-2 px-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg shadow-md transition duration-300"
              on:click={toggleEditing}>Annuler</button
            >
          </form>
        {:else}
          <div class="text-container" style="margin-left: 20px;">
            ...
            <div class="flex items-center mb-2 space-x-4">
              ...
              <button
                class="py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md transition duration-300"
                on:click={toggleEditing}>Modifier</button
              >
            </div>
  ...
  <div
    class="container mx-auto p-4 bg-gray-900 text-white rounded-lg shadow-lg"
  >
    <div class="bg-gray-800 rounded-lg shadow-md p-4 flex items-center">
      <div class="text-container" style="margin-left: 20px;">
